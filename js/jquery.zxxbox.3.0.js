...
(function($) {
		...
		'<div class="wrap_out" id="wrapOut">' +
			'<div class="wrap_in" id="wrapIn">' +
				'<div id="wrapBar" class="wrap_bar" onselectstart="return false;">' +
					'<h4 id="wrapTitle" class="wrap_title" style="float:left;"></h4>' +
					'<div class="wrap_close"><div style="cursor:pointer;border:0px solid blue;float:right;margin:3px;" id="wrapClose"></div></div><div style="clear:both;"></div>' +	
				'</div>' +
	...
	$.extend($.zxxbox, {
		...
		ask: function(message, sureCall, cancelCall, options) {
			var element = $('<div class="wrap_remind">'+message+'<p><button id="zxxSureBtn" class="submit_btn">submit</button>&nbsp;&nbsp;<button id="zxxCancelBtn" class="cancel_btn">cancel</button></p></div>');
			$.zxxbox(element, options);
			//回调方法
		...
		remind: function(message, callback, options) {
			var element = $('<div class="wrap_remind">'+message+'<p><button id="zxxSubmitBtn" class="submit_btn">submit</button</p></div>');
			$.zxxbox(element, options);
