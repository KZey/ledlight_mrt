<div class="form" style="border:1px solid gray;width:600px;height:360px; overflow:hidden;margin:0 auto;margin-top:50px;">
	<div style="border-bottom:1px solid gray;background:#C7D5DF;width:100%;height:30px; overflow:hidden;padding-top:10px;">
		<div style="float:left;padding-left:10px;">Create a password</div>
	...
	<div style="border:0px solid gray;width:100%;height:200px;margin:0 auto;">
		<div style="border:0px solid gray;width:80%;margin:0 auto;margin-top:60px;text-align:center;">
			<?php if($returnCode == 0){?>
		...
		<div style="border:0px solid gray;width:70%;margin:0 auto;margin-top:60px;text-align:center;">
			<?php if(Yii::app()->user->hasFlash('success')){
				...
				echo '<div class="info_error" style="color:red">'.Yii::app()->user->getFlash('error').'<a href="/'.BACKEND_ENTRY_NAME.'">Backend Home</a></div>'; 
			}?>
