<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->uid), array('view', 'uid'=>$data->uid)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('state_license')); ?>:</b>
	<?php echo CHtml::encode($data->state_license); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('forgetpwd')); ?>:</b>
	<?php echo CHtml::encode($data->forgetpwd); ?>
	<br />
