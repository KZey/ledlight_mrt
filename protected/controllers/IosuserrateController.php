...
class IosuserrateController extends Controller
{
	/**
	...
	public function actionView($id)
	{
       ...
       /**
       *
       * Rate and note an  User
       * @param: uid, UserID of the user to be rated
       * @param: fromid,  UserID of the user who gives rate
       * @param: rate
       * @param: note
       ...
       * 
       **/
        public function actionCreate($uid, $fromid, $rate=null, $note=null)
	{
		$model=new UserRate;
		...
		if(isset($uid)&&isset($fromid)&&isset($rate)&&isset($note))
		{
			$model->uid = $uid;
			$model->fromid = $fromid;
