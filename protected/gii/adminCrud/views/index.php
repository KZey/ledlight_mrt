...
$('#CustomCrudCode_controller').change(function(){
	$(this).data('changed',$(this).val()!='');
});
$('#CustomCrudCode_model').bind('keyup change', function(){
	var controller=$('#CustomCrudCode_controller');
...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row sticky">
		...
		<div class="tooltip">
			This refers to the module directory that the new file should be generated under.
			It should be specified in the form of a path alias, for example, <code>application.modules.test</code>.
		</div>
