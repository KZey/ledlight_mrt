...
class Manager extends BaseManager
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('uid, email, pwd, nickname, first_name, last_name, logo, sex, office, mobile, fax, about, state, city, last_time, this_time, service_email, add_time', 'safe', 'on'=>'search'),
		);
	}
