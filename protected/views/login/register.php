<div id="login_cont" style="border:0px solid red;overflow:hidden;width:100%;">
	<div style="float:right;width:100%;border:0px solid red;margin-top: 20px;">
		...
		<div style="border:1px solid #cccccc;height:580px;background:#EDEDED;padding-top:10px;">
			<div style="height:480px;;border:0px solid #cccccc;width:55%;margin:0 auto;">
				<?php echo $this->renderPartial('/user/index_regirest_form', array('modelUser'=>$modelUser,'type'=>$type,'agentList'=>$agentList,'header_class_1'=>$header_class_1,'header_class_2'=>$header_class_2)); ?>
