...
<option value="10" <?php if($modelProperty->baths == 10)echo 'selected';?> >10</option>
 ...
 -->
	...
	<div class="row" style="float:right;">
		<?php echo $form->labelEx($modelProperty,'roofing'); ?>
		<?php echo $form->textArea($modelProperty,'roofing',array('rows'=>2, 'style'=>'width:300px;')); ?>
		<?php echo $form->error($modelProperty,'roofing'); ?> 
	</div>
	 -->
