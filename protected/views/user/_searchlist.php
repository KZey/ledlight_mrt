<div  style="width:465px;background:#fff;height:180px;margin:5px;float:left;">
	<div  style="padding:10px;">
		<div style="width: 43%;float:left;border:0px solid red;">
			<a href="/property/<?php echo $data['property_id']; ?>">
				<img src="/upload/property/<?php echo $data['logo']; ?>" width=180 height=150 style="padding:3px;border:1px solid #cccccc;" /></a>
		</div>
		<div style="width: 55%;float:left;border:0px solid red;margin-left:3px;">
			...
			<div style="float:left;width: 100%;margin-top:10px;">
				...
				<div style="width: 100%;float:left;padding:3px;">
					...
					<div style="float:left;width: 60%;"><?php echo $data['house_size'];?></div>
				</div>
				<div class="clear"></div>
				...
				<div style="width: 100%;float:left;background:#f9f2f2;padding:3px;">
					...
					<div style="float:left;width: 60%;background:#f9f2f2;"><?php echo $data['lot_size'];?></div>
				</div>
				<div class="clear"></div>
